...
from .views import create_patient, get_patient, delete_patient, update_patients, get_all_patients
...
urlpatterns = [
    ...
    path('update_patient/<int:pk>', update_patients, name='update_patient'),
]